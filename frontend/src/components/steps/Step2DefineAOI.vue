...
<template>
    <div>
        ...
        <div class="aoi-list-manager space-y-2 h-[12vh] overflow-y-auto">
            <div v-for="(aoi, index) in projectData.aoiDrafts" :key="aoi.clientAoiId"
        ...
        {{ index= index + 1 }}. 
                        ...
                        {{ aoi.name }}
                        <span :class="{ 'text-yellow-400': aoi.bufferDistance }" class="text-sm ml-2">
                            ({{ aoi.geometryType }})
                        </span>
                    </div>
                    <div>
                        <span v-if="aoi.bufferDistance" class="text-sm text-green-400 ml-2">
            ...
            <p v-if="projectData.aoiDrafts.length === 0" class="text-center text-gray-400 p-4">
                ...
                <div
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-group">
                            <label class="block text-gray-400 mb-1">AOI Name: <span
                                    class="text-red-400">*</span></label>
                            <input type="text" v-model="currentAoiName" placeholder="Enter a name" required
                        ...
                        <div v-if="requiresBuffer" class="form-group">
                            ...
                            <p class="text-xs text-yellow-400 mt-1">
                                ...
                                A polygon will be created with this buffer zone around your {{ currentAoiType ===
                                'Point' ? 'point' : 'line' }}.
                            </p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div v-if="showNewAuxFields"
                                class="aux-data-entry p-3 bg-gray-700 rounded-lg border border-gray-600">
                                <div class="flex flex-col gap-2 mb-2">
                                    <input type="text" v-model="newAuxKey" placeholder="Key (e.g., Sensor Type)"
                                        class="w-full p-2 bg-gray-600 text-white rounded border border-gray-500 focus:border-cyan-400 focus:outline-none text-sm" />
                                    <input type="text" v-model="newAuxValue" placeholder="Value (e.g., Satellite)"
                                        class="w-full p-2 bg-gray-600 text-white rounded border border-gray-500 focus:border-cyan-400 focus:outline-none text-sm" />
                                </div>
